...
_A running log of what shipped for this product (newest first). The overnight
pipeline appends entries here as PRs merge — date, summary, and the PR/Jira ref._
